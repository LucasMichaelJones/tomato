...
function Pomodoro() {
  ...
  // null has no property label or something
          ...
          <div className="input-group input-group-lg mb-2">
            ...
            <div className="input-group-append">
              ...
              <button
                ...
                onClick={handlePlusFocusDuration}
            ...
            <div className="input-group input-group-lg mb-2">
              ...
              <div className="input-group-append">
                ...
                <button
                  ...
                  onClick={handlePlusBreakDuration}
